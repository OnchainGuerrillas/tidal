...
import type { InvestmentPerformance } from "@/mock-data/workspace/investments";
  ...
  return (
    <div className={cn("space-y-4", className)}>
      <div className="flex items-center justify-between gap-4">
        <p className="tidal-text-body">Workspace performance</p>
        ...
        <div className="grid grid-cols-[2.5rem_minmax(0,1fr)] gap-3">
          ...
          <div className="space-y-3">
            <svg
              ...
              role="img"
              aria-label="Workspace performance chart"
            >
              <defs>
                <linearGradient
                  id="workspaceChartArea"
                  x1="0"
                  x2="0"
                  y1="0"
                  y2="1"
              ...
              {areaPath ? (
                <path d={areaPath} fill="url(#workspaceChartArea)" />
              ) : null}
              {linePath ? (
                <path
                  d={linePath}
