...
export function WorkspacePromotionCard({
  ...
  const workspaceLabel = isPool ? "Pool" : "workspace";
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-1">
          <p className="tidal-text-body">
            {isPool ? "Promote to Pool thread" : "Promote to workspace chat"}
          </p>
          <p className="tidal-text-message">
            {isPool
              ? "This general chat is using Pool context without owning a dedicated Pool thread yet."
              : "This general chat is using workspace context without owning a dedicated workspace chat yet."}
          </p>
        </div>
      </div>
